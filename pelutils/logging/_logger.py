    ...
    def configure(
        ...
        *,
        ...
        if fpath is not None:
            self._rotater = LogFileRotater(rotation, Path(fpath))  # pyright: ignore[reportUninitializedInstanceVariable]
    ...
    def _log(
        ...
        *tolog: Any,  # pyright: ignore[reportExplicitAny]
        ...
        sep : str | None, optional
            String separator. If None, use default_separator from .configure is used, by default None.
